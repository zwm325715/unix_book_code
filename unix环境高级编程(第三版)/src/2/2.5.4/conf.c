...
int main(int argc, char *argv[]) {
...
#endif
#ifdef _SC_ARG_MAX
	pr_sysconf("sysconf()获得ARG_MAX =", _SC_ARG_MAX);
#else
	...
	pr_sysconf("sysconf()获得ATEXIT_MAX =", _SC_ATEXIT_MAX);
#else
	...
	pr_sysconf("sysconf()获得CHARCLASS_NAME_MAX =", _SC_CHARCLASS_NAME_MAX);
#else
...
#endif
#ifdef _SC_CHILD_MAX
	pr_sysconf("sysconf()获得CHILD_MAX =", _SC_CHILD_MAX);
#else
...
#endif
#ifdef _SC_CLK_TCK
	pr_sysconf("sysconf()获得CLOCKTICKSPERSECOND /*clock ticks/second*/ =", _SC_CLK_TCK);
#else
	...
	pr_sysconf("sysconf()获得COLL_WEIGHTS_MAX =", _SC_COLL_WEIGHTS_MAX);
#else
	...
	pr_sysconf("sysconf()获得DELAYTIMER_MAX =", _SC_DELAYTIMER_MAX);
#else
	...
	pr_sysconf("sysconf()获得HOST_NAME_MAX =", _SC_HOST_NAME_MAX);
#else
...
#endif
#ifdef _SC_IOV_MAX
	pr_sysconf("sysconf()获得IOV_MAX =", _SC_IOV_MAX);
#else
...
#endif
#ifdef _SC_LINE_MAX
	pr_sysconf("sysconf()获得LINE_MAX =", _SC_LINE_MAX);
#else
	...
	pr_sysconf("sysconf()获得LOGIN_NAME_MAX =", _SC_LOGIN_NAME_MAX);
#else
	...
	pr_sysconf("sysconf()获得NGROUPS_MAX =", _SC_NGROUPS_MAX);
#else
...
#endif
#ifdef _SC_OPEN_MAX
	pr_sysconf("sysconf()获得OPEN_MAX =", _SC_OPEN_MAX);
#else
...
#endif
#ifdef _SC_PAGESIZE
	pr_sysconf("sysconf()获得PAGESIZE =", _SC_PAGESIZE);
#else
...
#endif
#ifdef _SC_PAGE_SIZE
	pr_sysconf("sysconf()获得PAGE_SIZE =", _SC_PAGE_SIZE);
#else
	...
	pr_sysconf("sysconf()获得RE_DUP_MAX =", _SC_RE_DUP_MAX);
#else
...
#endif
#ifdef _SC_RTSIG_MAX
	pr_sysconf("sysconf()获得RTSIG_MAX =", _SC_RTSIG_MAX);
#else
	...
	pr_sysconf("sysconf()获得SEM_NSEMS_MAX =", _SC_SEM_NSEMS_MAX);
#else
	...
	pr_sysconf("sysconf()获得SEM_VALUE_MAX =", _SC_SEM_VALUE_MAX);
#else
	...
	pr_sysconf("sysconf()获得SIGQUEUE_MAX =", _SC_SIGQUEUE_MAX);
#else
	...
	pr_sysconf("sysconf()获得STREAM_MAX =", _SC_STREAM_MAX);
#else
	...
	pr_sysconf("sysconf()获得SYMLOOP_MAX =", _SC_SYMLOOP_MAX);
#else
...
#endif
#ifdef _SC_TIMER_MAX
	pr_sysconf("sysconf()获得TIMER_MAX =", _SC_TIMER_MAX);
#else
	...
	pr_sysconf("sysconf()获得TTY_NAME_MAX =", _SC_TTY_NAME_MAX);
#else
	...
	pr_sysconf("sysconf()获得TZNAME_MAX =", _SC_TZNAME_MAX);
#else
	...
	pr_pathconf("pathconf()获得FILESIZEBITS =", argv[1], _PC_FILESIZEBITS);
#else
...
#endif
#ifdef _PC_LINK_MAX
	pr_pathconf("pathconf()获得LINK_MAX =", argv[1], _PC_LINK_MAX);
#else
...
#endif
#ifdef _PC_MAX_CANON
	pr_pathconf("pathconf()获得MAX_CANON =", argv[1], _PC_MAX_CANON);
#else
...
#endif
#ifdef _PC_MAX_INPUT
	pr_pathconf("pathconf()获得MAX_INPUT =", argv[1], _PC_MAX_INPUT);
#else
...
#endif
#ifdef _PC_NAME_MAX
	pr_pathconf("pathconf()获得NAME_MAX =", argv[1], _PC_NAME_MAX);
#else
...
#endif
#ifdef _PC_PATH_MAX
	pr_pathconf("pathconf()获得PATH_MAX =", argv[1], _PC_PATH_MAX);
#else
...
#endif
#ifdef _PC_PIPE_BUF
	pr_pathconf("pathconf()获得PIPE_BUF =", argv[1], _PC_PIPE_BUF);
#else
	...
	pr_pathconf("pathconf()获得SYMLINK_MAX =", argv[1], _PC_SYMLINK_MAX);
#else
	...
	pr_pathconf("pathconf()获得_POSIX_TIMESTAMP_RESOLUTION =", argv[1], _PC_TIMESTAMP_RESOLUTION);
#else
